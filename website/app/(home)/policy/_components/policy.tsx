      ...
      <div className="space-y-6">
        <section>
          ...
          <p className="text-gray-300">
            We only collect what's necessary to provide our search service. We
            don't sell your data. We respect website owners' rules.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-300">
            <li>
              <strong>Account Info:</strong> Just your email and name
            </li>
            <li>
              <strong>Search Data:</strong> Websites you ask us to index
            </li>
            <li>
              <strong>Basic Usage:</strong> How you interact with our service
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <div className="text-gray-300 space-y-2">
            ...
            <ul className="list-disc pl-6">
              <li>Our hosting providers (Vercel, Cloudflare)</li>
              <li>Essential service tools (Resend Emails)</li>
            </ul>
          </div>
        </section>
        ...
        <div className="pt-6 border-t border-gray-700">
          <p className="text-sm text-gray-400">
            We'll update this policy as we grow. Major changes will be emailed
            to users.
          </p>
        </div>
      </div>
