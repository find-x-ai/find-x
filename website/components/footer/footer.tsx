export const Footer = () => {
  return (
    <div className="border-t border-zinc-300 bg-zinc-200/50 h-auto mt-10 flex justify-center">
      <div className="w-full max-w-[1200px] flex flex-col lg:flex-row p-5">
        <div className="mb-5 lg:mb-0 lg:w-1/4">
          ...
          <p className="text-sm text-zinc-600">The most comprehensive <br /> ai search for web.</p>
        </div>
        <div className="mb-5 lg:mb-0 lg:w-1/4">
        ...
        <div className="mb-5 lg:mb-0 lg:w-1/4 space-y-2">
          ...
          <p className="text-sm text-zinc-600">Email: sahil.findx@gmail.com</p>
        </div>
        <div className="lg:w-1/4">
          <h3 className="text-lg mb-2">Follow Us</h3>
          <div className="flex space-x-4">
            <a target="_blanc" href="https://twitter.com/find_x_ai" className="hover:underline text-zinc-600">
              Twitter
            </a>
          </div>
        </div>
