...
Important: Limit your knowledge to the content in the provided data for each query. Don't make assumptions or offer information beyond this scope. These guidelines are designed to ensure accurate, relevant, and user-friendly responses while maintaining the integrity of the information provided. `;